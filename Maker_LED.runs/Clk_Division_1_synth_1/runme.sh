...
HD_PWD='D:/saillingsi/camera/Camera_Demo/Camera_Demo.runs/Clk_Division_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Clk_Division_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Clk_Division_1.tcl
