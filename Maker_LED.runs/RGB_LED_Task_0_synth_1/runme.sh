...
HD_PWD='D:/saillingsi/camera/Camera_Demo/Camera_Demo.runs/RGB_LED_Task_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RGB_LED_Task_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RGB_LED_Task_0.tcl
