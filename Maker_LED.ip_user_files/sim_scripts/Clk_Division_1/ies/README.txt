...
#
# Generated by export_simulation on Wed Jul 29 18:11:30 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './Clk_Division_1.sh' script.

./Clk_Division_1.sh -reset_run
...
./Clk_Division_1.sh -noclean_files

For more information on the script, please type './Clk_Division_1.sh -help'.
