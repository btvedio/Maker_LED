...
#
# Generated by export_simulation on Wed Jul 29 18:21:41 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './RGB_LED_Task_0.sh' script.

./RGB_LED_Task_0.sh -reset_run
...
./RGB_LED_Task_0.sh -noclean_files

For more information on the script, please type './RGB_LED_Task_0.sh -help'.
